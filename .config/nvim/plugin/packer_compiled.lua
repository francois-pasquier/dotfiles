...
_G.packer_plugins = {
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/Users/chell/.local/share/nvim/site/pack/packer/start/editorconfig-vim"
  },
  ["formatter.nvim"] = {
    loaded = true,
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/chell/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim"
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-spectre', 'gitsigns.nvim', 'todo-comments.nvim', 'lsp-colors.nvim', 'lspsaga.nvim', 'lightspeed.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
