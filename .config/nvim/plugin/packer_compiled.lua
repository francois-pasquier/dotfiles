...
_G.packer_plugins = {
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/home/chell/.local/share/nvim/site/pack/packer/start/editorconfig-vim"
  },
  ["formatter.nvim"] = {
    loaded = true,
  ...
  ["lightspeed.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/chell/.local/share/nvim/site/pack/packer/opt/lightspeed.nvim"
  },
  ["lsp-colors.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  neogit = {
    ...
    loaded = true,
    path = "/home/chell/.local/share/nvim/site/pack/packer/start/neogit"
  },
  ["neoscroll.nvim"] = {
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/chell/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/chell/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim"
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lightspeed.nvim', 'lsp-colors.nvim', 'nvim-spectre', 'numb.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
